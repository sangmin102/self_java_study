...
public class _04_Operator4 {
    public static void main(String[] args) {
        ...
        System.out.println(김치찌개 && 계란말이 && 제육볶음);//모두 true면 true 괜찮은 식당
...
//        System.out.println((5 < 3 > 1)); 연속적인 비교는  x 불가능

        System.out.println(1 < 3 && 3 < 5); // 괄호는 사용하지 않아도 되지만 가독성을 위해 괄호 사용
